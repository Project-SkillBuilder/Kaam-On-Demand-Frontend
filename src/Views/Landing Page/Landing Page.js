        ...
        <div className="main body">
          ...
          <div className="banner1">
            <div className="text-box1 text-box11">
              <h1>Kaam On Demand</h1>
              <span />
              <div className="btn-know" style={{position:"absolute",right:"200px",top:"200px"}}>
          ...
          <div className="bottom" id="bottom-content">
            <div className="d-flex flexbox-main flex-lg-column justify-content-start">
              <div className="d-flex flexbox flex-lg-row align-items-lg-center">
                <div
                  className="card row col-5 border ma5 grow shadow-4"
                  style={{ height: "210px" }}
                >
                  ...
                  <div className="contentbox">
                    <p>
                      ...
                      Suspendisse hendrerit neque sit amet erat sagittis
                      sagittis. Morbi mattis erat quam, id pretium nulla mollis
                      quis. Ut feugiat condimentum quam, accumsan convallis diam
                      aliquet nec. Vestibulum non erat orci. Morbi vitae arcu
                      congue, fermentum enim nec, scelerisque turpis. Curabitur
                      at quam dapibus, molestie sapien nec, tempus justo. Duis
                      vel facilisis velit. Ut sodales velit enim, a congue ex
                      volutpat et.
                    </p>
                  </div>
                </div>
